  ...
  <div class="apply-account">
    <div class="form">
      ...
      <div class="form-item">
        ...
        <van-field type="password" v-model="formObj.password" placeholder="请输入6位以上密码" />
      </div>
      <div class="form-item">
        <img src="../../assets/login_password.png" alt="" srcset="" />
        <van-field type="password" v-model="formObj.password1" placeholder="请输入确认密码" />
      </div>
      <div class="form-item">
...
export default {
  ...
  created() {
    ...
    this.getJobList()
    this.userInfo = JSON.parse(localStorage.getItem('formObj'))
    console.log('this.userInfo', this.userInfo)
    this.formObj.idNo = this.userInfo.idNo
  ...
  methods: {
    ...
    onConfirm(value) {
      ...
      let index = this.jobList.findIndex(item => item == value)
      this.formObj.job = this.jobCodeList[index];
    ...
    handleSubmit() {
      ...
      this.$http
        .post("/human/xingyetwocard/openOrdinaryAccount", {
          ...this.formObj,
